...
StockVO _$StockVOFromJson(Map<String, dynamic> json) => StockVO(
  ...
  purchaseOrderQuantity: (json['purchaseorder_qty'] as num?) ?? 0,
  csoQuantity: (json['cso_qty'] as num?) ?? 0,
...
StockVO _$StockVOFromJsonNetwork(Map<String, dynamic> json) => StockVO(
  ...
  staticQuantity: json['static_quantity'],
  pictureFileName: json['picture_file_name'] as String?,
  imageUrl: json['imageUrl'] as String?,
  goodsTax: json['goods_tax'] as String?,
  salesTax: json['sales_tax'] as String?,
...
Map<String, dynamic> _$StockVOToJson(
  ...
  'purchaseorder_qty': instance.purchaseOrderQuantity,
  'cso_qty': instance.csoQuantity,
